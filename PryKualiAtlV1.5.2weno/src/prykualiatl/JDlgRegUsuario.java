...
public void mostrar(String cla,String usu,String contr,boolean ara,boolean b,boolean c,boolean d,boolean e,boolean f,boolean g,boolean h,boolean i,boolean j,boolean k,boolean l,boolean m,boolean n,boolean o,boolean p,boolean q,boolean r,boolean s,boolean t,boolean u)
{
        ...
        this.jCheckBox20.setSelected(s);
        this.jCheckBox21.setSelected(t);
        this.jCheckBox22.setSelected(u);
    }
...
//  /////////////////////////menu6////////////////////////////////////////////
        ...
        {
            num=1;
              m.getJMenuBar().getMenu(5).setEnabled(true);
        }
         else
          {
            num=0;
            m.getJMenuBar().getMenu(5).setEnabled(false);
          }
        if (jCheckBox21.isSelected())
         {
            num=1;
            m.getJMenuBar().getMenu(5).getItem(0).setEnabled(true);
         }
          else
          {
            num=0;
            m.getJMenuBar().getMenu(5).getItem(0).setEnabled(false);
          }
        if (jCheckBox22.isSelected())
         {
            num=1;
            m.getJMenuBar().getMenu(5).getItem(1).setEnabled(true);
         }
          else
          {
            num=0;
            m.getJMenuBar().getMenu(5).getItem(1).setEnabled(false);
          }
   ...
   if(    jTextField2.getText().equals("GUARDAR"))
   {
        ...
        bd_manager obj = new bd_manager();
        String sql;
        sql = ("INSERT INTO tblusuario (ClvUsuario,Usuario,Contraseña,Archivo,IniciarSesion,CerrarSesion,RegistroDeUsuario,SalirDeAplicacion,Clientes,RegistroDeClientes,Pagos,RegistroDePagos,EmisionesOrdenes,Reportes,ReporteDeIngresos,ReporteDePagos,ReporteDeOrdenes,Herramientas,Calculadora,RespaldarBd,RestaurarBd,Ayuda,MostrarAyuda,AcercaDe) Values (" + JTxtClave.getText() + ",'" + JTxtUsuario.getText() + "','" + JTxtContraseña.getText() + "'," + this.jCheckBox1.isSelected() + "," + this.jCheckBox2.isSelected() + "," + this.jCheckBox3.isSelected() + "," + this.jCheckBox4.isSelected() + "," + this.jCheckBox5.isSelected() + "," + this.jCheckBox6.isSelected() + "," + this.jCheckBox7.isSelected() + "," + this.jCheckBox8.isSelected() + "," + this.jCheckBox9.isSelected() + "," + this.jCheckBox10.isSelected() + "," + this.jCheckBox11.isSelected() + "," + this.jCheckBox12.isSelected() + "," + this.jCheckBox13.isSelected() + "," + this.jCheckBox14.isSelected() + "," + this.jCheckBox15.isSelected() + "," + this.jCheckBox16.isSelected() + "," + this.jCheckBox17.isSelected() + "," + this.jCheckBox18.isSelected() + "," + this.jCheckBox20.isSelected() + "," + this.jCheckBox21.isSelected() + "," + this.jCheckBox22.isSelected() + ")");
        obj.AbcProye(sql);
