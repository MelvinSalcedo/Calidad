...
public class JDlgUsuarios extends javax.swing.JDialog
{
    ...
    public boolean herramientass,calculadoraa,respaldarbdd,restaurarbdd,ayudaa,mostrarayudaa,acercadee;
...
public void muestra()
 ...
 this.ayudaa= Boolean.valueOf(contenido[JTblUsuarios.getSelectedRow()][20].toString());
 this.mostrarayudaa= Boolean.valueOf(contenido[JTblUsuarios.getSelectedRow()][21].toString());
 this.acercadee= Boolean.valueOf(contenido[JTblUsuarios.getSelectedRow()][22].toString());
