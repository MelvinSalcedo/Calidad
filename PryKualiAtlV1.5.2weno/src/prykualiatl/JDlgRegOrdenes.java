...
public void mostrar(String noordenn,String fechaa,String tipoo,String inspectorr,String nocuentaa,String nombree,String diree,String coloniaa,String munii,String telee,String rfcc,String mot)
{
        this.JTxtNoOrden.setText(noordenn.trim());
        this.JTxtFecha.setText(fechaa.trim());
        this.JCmbTipo.getModel().setSelectedItem(tipoo.trim());
         this.JTxtInspector.setText(inspectorr.trim());
       //  this.JTxtNoCliente.setText(clvclientee.trim());
        ...
        this.JTxtTelefono.setText(telee.trim());
        this.JTxtRfc.setText(rfcc.trim());
        this.JTxtMotivo.setText(mot.trim());
    }
    ...
    try
            {
               ...
               String sql;
               ResultSet rs;
               sql=("select NoOrden FROM tblorden ");
              ...
              while (rs.next())
               {
                  ...
                  this.JTxtNoOrden.setText(Integer.toString(clavenueva));
            }catch (Exception ex) {
    ...
    if(JTxtNoCuenta.getText().equals(""))
        ...
        if(JBtnBuscar.isEnabled())
        {
            try
            {
               ...
               String sql;
               ResultSet rs;
               sql=("select NoCuenta,Nombre,Direccion,Colonia,Municipio,Telefono,Rfc  FROM tblcliente WHERE NoCuenta='" + JTxtNoCuenta.getText() + "'");
               rs= obj.consultar(sql);
               b=JTxtNoCuenta.getText();
               boolean encuentra=false;
               while (rs.next())
               {
                 if(b.equals(rs.getString(1)))
                 {
                   //  JTxtNoCliente.setText((String)rs.getString(1));
                     JTxtNombre.setText((String)rs.getString(2));
                     JTxtDireccion.setText((String)rs.getString(3));
                     JTxtColonia.setText((String)rs.getString(4));
                     JTxtMunicipio.setText((String)rs.getString(5));
                     JTxtTelefono.setText((String)rs.getString(6));
                     JTxtRfc.setText((String)rs.getString(7));
                     encuentra=true;
                     break;
                 }
               }
                ...
                try
                 {
                    ...
                    String sql;
                          ...
                          sql = ("INSERT INTO tblorden (NoOrden,Fecha,NoCuenta,Tipo,Inspector,MotivoCorte) Values (" + JTxtNoOrden.getText() + ",'" + JTxtFecha.getText() + "'," + JTxtNoCuenta.getText() + ",'" + JCmbTipo.getModel().getSelectedItem() + "','" + JTxtInspector.getText() + "','" + JTxtMotivo.getText() + "')");
                        obj.AbcProye(sql);
...
else
{
      ...
      try
                 {
                    bd_manager obj = new bd_manager();
                    String sql;
                          sql = ("UPDATE tblorden SET Fecha='" + JTxtFecha.getText() + "',Tipo='" + JCmbTipo.getModel().getSelectedItem() + "',Inspector='" + JTxtInspector.getText() + "',MotivoCorte='" + JTxtMotivo.getText() + "' where NoOrden=" + JTxtNoOrden.getText() + "");
                        obj.AbcProye(sql);
 JOptionPane.showMessageDialog( null, "REGISTRO ACTUALIZADO CORRECTAMENTE", "ACTUALIZANDO", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void JBtnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBtnImprimirActionPerformed
        ...
        this.folioo=String.valueOf(this.JTxtNoOrden.getText());
        this.cuentaa=String.valueOf(this.JTxtNoCuenta.getText());
       // this.cliente=String.valueOf(this.JTxtNoCliente.getText());
        ...
        this.tele=String.valueOf(this.JTxtTelefono.getText());
        this.rfcc=String.valueOf(this.JTxtRfc.getText());
        this.inspectorr=String.valueOf(this.JTxtInspector.getText());
        this.tipoo=String.valueOf(this.JCmbTipo.getModel().getSelectedItem());
        this.motivos=String.valueOf(this.JTxtMotivo.getText());
