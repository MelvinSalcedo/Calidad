...
public void mostrar(String cuenta,String nombre,String dato,String telefono,String rfc,String colonia,String comunidad,String municipio,String codigopostal,String tarifa,String fechas)

    {
        //this.JTxtClave.setText(cl.trim());
        this.JTxtNoCuenta.setText(cuenta.trim());
        this.JTxtNombre.setText(nombre.trim());
        this.JTxtDireccion.setText(dato.trim());
        this.JTxtTelefono.setText(telefono.trim());
        this.JTxtRfc.setText(rfc.trim());
        this.JTxtColonia.setText(colonia.trim());
        this.JTxtComunidad.setText(comunidad.trim());
        this.JTxtMunicipio.setText(municipio.trim());
        this.JTxtCodigoPostal.setText(codigopostal.trim());
        this.JCmbTarifa.getModel().setSelectedItem(tarifa.trim());
        this.jTextField1.setText(fechas.trim());
    }
    ...
    try
            {
               ...
               String sql;
               ResultSet rs;
               sql=("select NoCuenta FROM tblcliente ");
              ...
              int a;
               ...
               while (rs.next())
               {
                  ...
                  this.JTxtNoCuenta.setText(Integer.toString(clavenueva));
            }catch (Exception ex) {
                             ...
                             if(    jTextField2.getText().equals("GUARDAR"))
                              {
                                 try
                                 {
                                    bd_manager obj = new bd_manager();
                                    String sql;
                                    sql = ("INSERT INTO tblcliente (NoCuenta,Nombre,Direccion,Telefono,Rfc,Colonia,Comunidad,Municipio,CodigoPostal,Tarifa,FechaRegistro) Values (" + JTxtNoCuenta.getText() + ",'" + JTxtNombre.getText() + "','" + JTxtDireccion.getText() + "'," + JTxtTelefono.getText() + ",'" + JTxtRfc.getText() + "','" + JTxtColonia.getText() + "','" + JTxtComunidad.getText() + "','" + JTxtMunicipio.getText() + "'," + JTxtCodigoPostal.getText() + ",'" + JCmbTarifa.getModel().getSelectedItem() + "','" + jTextField1.getText() + "')");
                                    obj.AbcProye(sql);
                                    ...
                                    try
                                     {
                                        bd_manager obj = new bd_manager();
                                        String sql;
                                        sql = ("UPDATE tblcliente SET Nombre='" + JTxtNombre.getText() + "',Direccion='" + JTxtDireccion.getText() + "',Telefono=" + JTxtTelefono.getText() + ",Rfc='" + JTxtRfc.getText() + "',Colonia='" + JTxtColonia.getText() + "',Comunidad='" + JTxtComunidad.getText() + "',Municipio='" + JTxtMunicipio.getText() + "',CodigoPostal=" + JTxtCodigoPostal.getText() + ",Tarifa='" + JCmbTarifa.getModel().getSelectedItem() + "',FechaRegistro='" + jTextField1.getText() + "' where NoCuenta=" + JTxtNoCuenta.getText() + "");
                                        obj.AbcProye(sql);
